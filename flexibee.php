...
$column1->addItem(new \Ease\Html\ImgTag('img/deb/flexibee-server.png',
        'FlexiBee server', ['class' => 'img-responsive']));
...
$column1->addItem(new \Ease\Html\ImgTag('img/deb/flexibee-server-backup.png',
        _('FlexiBee server backup'), ['class' => 'img-responsive']));
...
$column2->addItem(new \Ease\Html\ImgTag('img/deb/flexipeehp.png',
        _('FlexiPeeHP Library'), ['class' => 'img-responsive']));
...
$column2->addItem(new \Ease\Html\ImgTag('https://www.vitexsoftware.cz/img/deb/flexplorer.png',
        'FlexiBee server', ['class' => 'img-responsive']));
...
$column3->addItem(new \Ease\Html\ImgTag('img/flexiproxy-logo.png',
        'FlexiProxy logo', ['class' => 'img-responsive']));
...
$column3->addItem(new \Ease\TWB\LinkButton('https://shop4flexibee.vitexsoftware.cz/',
        [new \Ease\Html\ImgTag('img/shop4flexibee-logo.svg',
            'Shop4FlexiBee logo', ['style' => 'height: 30px;']), ' ', _('Live Customer Demo').' »'],
        'success btn-lg'));
...
$column3->addItem(new \Ease\TWB\LinkButton('https://shop4flexibee.vitexsoftware.cz/adminlogin.php',
        [new \Ease\Html\ImgTag('img/shop4flexibee-logo.svg',
            'Shop4FlexiBee logo', ['style' => 'height: 30px;']), ' ', _('Live Admin Demo').' »'],
        'success btn-lg'));
...
$column1->addItem(new \Ease\Html\H3Tag(_("Testing Tools")));
$column1->addItem(new \Ease\Html\ImgTag('img/deb/flexibee-testing-tools.png',
        _('FlexiBee server backup'), ['class' => 'img-responsive']));
$column1->addItem(new \Ease\Html\DivTag(_('Set of commandline tools related to testing FlexiBee functionality'),
        ['style' => 'margin: 5px;']));

$column1->addItem(new \Ease\TWB\LinkButton('https://github.com/VitexSoftware/FlexiBee-TestingTools',
        '<i class = "fa fa-github"></i> '._('Source codes').' »', 'info'));
