...
$oPage->addItem(new VSPageTop(_('Ease Framework'))); $oPage->AddItem('<a href="https://github.com/Vitexus/EaseFramework" class="ribbon bg-teal">Forkni na GitHubu</a>');
...
$oPage->column3->addItem(new EaseHtmlH3Tag(_('Ke stažení')));
...
$oPage->column3->addItem(new EaseHtmlATag('download/Ease.tar.bz2', 'Ease.tar.bz2 '.$downloads['Ease.tar.bz2'] ,array('class'=>'btn btn-success')));
$oPage->column3->addItem(new EaseHtmlATag('download/'.key($package),'<img style="width: 42px;" src="img/deb-package.png">&nbsp;' .  key($package) . ' '.current($package) ,array('class'=>'btn btn-success')));
...
$oPage->column3->addItem(new EaseHtmlATag('download/LinkQuick.tar.bz2', 'bz2 '.$downloads['LinkQuick.tar.bz2'],array('class'=>'btn btn-success')));
$oPage->column3->addItem('</div>');

$CodFS = $oPage->column2->addItem(new EaseHtmlFieldSet(_('Ukázka kódu')));
...
$oPage->column2->addItem(new EaseHtmlFieldSet(_('Výsledek: jQueryUI tlačítko')));

$oPage->column2->addItem(new EaseJQueryLinkButton('http://l.q.cz/', 'zkracovač'));

$oPage->column1->addItem(new EaseHtmlATag('EaseDoc', 'Dokumentace Apigen',array('class'=>'btn btn-info')));
$oPage->column1->addItem(new EaseHtmlATag('https://github.com/Vitexus/EaseFramework', 'GitHub',array('class'=>'btn btn-info')));
$oPage->column1->addItem(new EaseHtmlATag('/websvn/rss.php?repname=Ease+Framework', 'RSS kanál',array('class'=>'btn btn-info')));
$oPage->column1->addItem(new EaseHtmlATag('http://redmine.murka.cz/projects/ease-framework', 'Redmine',array('class'=>'btn btn-info')));
...
$oPage->column1->addItem(new EaseHtmlFieldSet(_('Proč použít ?')));
